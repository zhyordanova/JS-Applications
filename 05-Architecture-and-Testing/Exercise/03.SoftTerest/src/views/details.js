...
function createIdeaDiv(idea) {
    ...
    /*<img class="det-img" src="./images/dinner.jpg" />
        <div class="desc">
            ...
            <p class="idea-description">There are few things as comforting as heaping bowl of pasta at the end
                of a
                long
                day. With so many easy pasta recipes out there, there's something for every palate to love.
                That's
                why
                pasta
